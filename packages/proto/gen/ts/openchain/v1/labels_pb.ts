 ...
 */
export class AddLabelRequest extends Message<AddLabelRequest> {
  /**
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "openchain.v1.AddLabelRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AddLabelRequest {
    return new AddLabelRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AddLabelRequest {
    return new AddLabelRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AddLabelRequest {
    return new AddLabelRequest().fromJsonString(jsonString, options);
  }

  static equals(a: AddLabelRequest | PlainMessage<AddLabelRequest> | undefined, b: AddLabelRequest | PlainMessage<AddLabelRequest> | undefined): boolean {
    return proto3.util.equals(AddLabelRequest, a, b);
  }
}
 ...
 */
export class AddLabelResponse extends Message<AddLabelResponse> {
  /**
   * @generated from field: openchain.v1.AddressLabel label = 1;
   */
  label?: AddressLabel;

  constructor(data?: PartialMessage<AddLabelResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "openchain.v1.AddLabelResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "label", kind: "message", T: AddressLabel },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AddLabelResponse {
    return new AddLabelResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AddLabelResponse {
    return new AddLabelResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AddLabelResponse {
    return new AddLabelResponse().fromJsonString(jsonString, options);
  }

  static equals(a: AddLabelResponse | PlainMessage<AddLabelResponse> | undefined, b: AddLabelResponse | PlainMessage<AddLabelResponse> | undefined): boolean {
    return proto3.util.equals(AddLabelResponse, a, b);
  }
}
