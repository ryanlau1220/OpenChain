import { FileJson, FileText, FolderKanban, Plus } from 'lucide-react';
		...
		<div className="p-8 max-w-5xl mx-auto space-y-6">
			<div>
				...
				<p className="text-xs text-slate-400">
					Manage investigation dossiers and export evidence reports
					(PDF/CSV/JSON).
				</p>
			</div>
			...
			<div className="space-y-4">
				<h3 className="text-xs font-bold uppercase tracking-wider text-slate-400">
					Active Investigation Dossiers ({cases.length})
				</h3>
				{cases.map((c) => (
					<div
						key={c.id}
						className="p-6 glass-panel rounded-2xl flex items-center justify-between gap-4 border-l-4 border-cyan-500"
					>
