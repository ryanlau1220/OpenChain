  ...
  return (
    <div className="p-8 max-w-5xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4">
        {rules.map((rule) => (
          <div key={rule.id} className="p-5 glass-panel rounded-2xl flex items-center justify-between border-l-4 border-amber-500">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <span className="font-mono font-bold text-xs text-amber-400">{rule.id}</span>
            ...
            <div className="text-right">
              <span className="text-lg font-mono font-bold text-slate-200">+{rule.score}</span>
